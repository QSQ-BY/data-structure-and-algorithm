...
最近的独立练习是 [P2895 流星雨与 P1332 血色先锋队](diary/Exercise/P_2895_USACO_08_FEB_Meteor_Shower_S-P_1332_血色先锋队.md)，对比了带截止时间的单源逃生与一次预处理全部位置的多源 BFS，也记录了边界判断和访问标记带来的几次修正。
