...
| 动态规划 | 状态定义、递推关系、边界初始化、滚动数组 | 数列递推、数字三角形、0/1 背包、完全背包、多重背包 |
...
比赛过程单独记录在 [AtCoder AWC 0135 Beta 复盘](contest/atcoder/awc0135beta/2026-08-14_atcoder.md)、[Codeforces Round 1109（Div. 3）复盘](contest/codeforces/round_1109_Div3/2026-07-30_cf.md) 和 [Codeforces Round 1116（Div. 2）复盘](contest/codeforces/round_1116_Div2/2026-08-09_cf.md) 中。
