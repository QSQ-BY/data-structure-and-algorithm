...
9 月 16 日的[荒谬、补码配对与异或乘积练习日志](diary/Exercise/P_14145_荒谬-P_13551_ももいろの鍵-P_13685_MX_X_16_T_3_DLESS_3_XOR_and_Impossible_Problem.md)分别记录了 P14145 的分治连边、P13551 的倒序补码配对与 `used` 标记，以及 P13685 利用偶数因子提前判断零答案的方法，保留了补码是否重复匹配 0、阈值是否必须最紧的讨论。

9 月 15 日的[花朵配对与整除构造练习日志](diary/Exercise/P_16494_樱蕊初含雪_惜春时易逝-P_15861_LBA_OI_R_3_A_A_Step_Back.md)整理了 P16494 的最大配对数证明与落单美观度的分类讨论，以及 P15861 用 `1`、`2` 构造最短序列的方法，保留了“先把两种颜色配完会怎样”和“最后放一个 `3` 行不行”的追问。
